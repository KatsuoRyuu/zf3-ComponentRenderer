...
use KryuuCommon\ComponentRenderer\Renderer\ComponentRenderer;
use Zend\View\ViewEvent;
use KryuuCommon\ComponentRenderer\Model\ComponentModel;

class ComponentStrategy extends AbstractListenerAggregate
{
    /**
