 ...
 * @method \Zend\View\Helper\FlashMessenger flashMessenger($namespace KryuuCommon\= null)
 ...
 */
class ComponentRenderer implements Renderer, TreeRendererInterface
{
    /**
    ...
    public function render($nameOrModel, $values = null)
    {
        ...
        while ($this->__template = array_pop($this->__templates)) {
            ...
            try {
                ob_start();
                $this->__file = $this->parseComponents($this->__file);
    ...
    public function parseComponents($file)
    {
        return $this
                ->__compiler
                ->loadFile($file)
